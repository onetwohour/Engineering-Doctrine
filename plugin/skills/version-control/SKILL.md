...
description: "Running git: staging, committing, branching, stashing, resetting, rebasing, amending, force-pushing, or otherwise touching history. Read this doctrine BEFORE performing git mutation or history-changing operations."
---
