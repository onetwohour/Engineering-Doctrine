...
description: Keeps authored artifacts grounded in the actual project, domain, audience, medium, platform, and evidence instead of generic model defaults. Applies to authored artifact creation and material changes.
